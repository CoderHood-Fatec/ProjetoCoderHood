...
| 3  | **Gerenciamento de Ciclo de Entregas** O Professor precisa criar atividades  o ciclo de entregas, para isso precisa ser delimitado a data inicial e a data final    | Content Cell  | [#2](https://trello.com/c/jyWWDRxE/15-criar-ciclo-de-entrega) |
| 4  | **Gerenciamento de notas:** O professor precisa inserir as notas pros alunos para avaliá-los após a data final de um ciclo de entregas.| Content Cell  | [#2](https://trello.com/c/74CfZiV4/14-visualizar-notas) |
